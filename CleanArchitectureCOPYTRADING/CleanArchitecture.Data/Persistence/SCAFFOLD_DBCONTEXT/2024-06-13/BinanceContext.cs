...
namespace CleanArchitecture.Infrastructure.Persistence.SCAFFOLD_DBCONTEXT.2024-06-13
{
    public partial class BinanceContext : DbContext
    {
        ...
        public virtual DbSet<BinanceTraderPerformanceRetList> BinanceTraderPerformanceRetLists { get; set; } = null!;
        public virtual DbSet<BinanceTraderPerformanceRetListAudit> BinanceTraderPerformanceRetListAudits { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Password=xiomaraA1;Persist Security Info=True;User ID=linagma32046com26487_artelcom;Initial Catalog=Binance;Data Source=DESKTOP-U698D3E;TrustServerCertificate=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<BinanceTraderPerformanceRetList>(entity =>
            {
                ...
                entity.HasOne(d => d.EncryptedU)
                    .WithMany(p => p.BinanceTraderPerformanceRetLists)
                    .HasForeignKey(d => d.EncryptedUid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<BinanceTraderPerformanceRetListAudit>(entity =>
            {
                ...
                entity.HasOne(d => d.EncryptedU)
                    .WithMany(p => p.BinanceTraderPerformanceRetListAudits)
                    .HasForeignKey(d => d.EncryptedUid)
                    .OnDelete(DeleteBehavior.ClientSetNull)
